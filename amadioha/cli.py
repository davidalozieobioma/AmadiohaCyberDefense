...
For help on a specific command:
  ...
  amadioha report --help
    ...
    scan_parser.add_argument("--profile", choices=["fast", "balanced", "safe"], default="balanced", help="Scan profile")
    ...
    analyze_parser = subparsers.add_parser("analyze", help="Analyze auth logs for brute-force attacks")
    ...
    report_parser.add_argument("--profile", choices=["fast", "balanced", "safe"], default="balanced", help="Scan profile")
    report_parser.add_argument("--scan-workers", type=int, default=None, help="Override scan workers")
    report_parser.add_argument("--scan-timeout", type=float, default=None, help="Override scan timeout")
